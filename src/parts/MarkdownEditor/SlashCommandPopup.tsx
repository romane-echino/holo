...
const COMMANDS: SlashCommand[] = [
  ...
  { id: 'html',         label: 'Bloc HTML',       description: 'HTML éditable avec rendu live', icon: '<>', blockType: 'html', keywords: ['html', 'raw', 'markup', 'embed', 'balise'] },
  { id: 'youtube',      label: 'Vidéo YouTube',   description: 'Embed YouTube responsive à partir d’un lien', icon: '▶', blockType: 'youtube', keywords: ['youtube', 'video', 'embed', 'iframe', 'youtu.be'] },
  { id: 'mermaid',      label: 'Diagramme Mermaid', description: 'Diagramme flowchart / graph Mermaid', icon: '◈', blockType: 'mermaid', keywords: ['mermaid', 'diagramme', 'flowchart', 'graph', 'schema'] },
  { id: 'details',      label: 'Section repliable', description: 'Bloc GitHub <details><summary>…</summary>', icon: '▾', blockType: 'details', keywords: ['details', 'summary', 'collapsible', 'repliable', 'github', 'accordeon'] },
  ...
  { id: 'blockquote-alert-note', label: 'Alerte note', description: 'Citation GitHub [!NOTE]', icon: 'ⓘ', blockType: 'blockquote-alert:note', keywords: ['alert', 'note', 'github', 'admonition', 'callout'] },
  { id: 'blockquote-alert-tip', label: 'Alerte astuce', description: 'Citation GitHub [!TIP]', icon: '✦', blockType: 'blockquote-alert:tip', keywords: ['alert', 'tip', 'astuce', 'github', 'admonition', 'callout'] },
