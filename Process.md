...
- Statut global : Étapes 1, 2, 3 terminées | Étape 4 (StageA) en cours
...
| Étape 4A — UI/UX finale (Layout) | ✅ Terminé | 25/03/2026 | Sidebar (2 icônes: Files/Git), panels actifsfiles/Git, système d'onglets multi-fichiers, éditeur RAW dark |
| Étape 4B — Drag & drop | ⏳ À faire | — | Réorganiser fichiers/dossiers dans la vue |
| Étape 4C — Éditeur WYSIWYG | ⏳ À faire | — | Mode prévisualisation Markdown + éditeur visuel |
| Étape 5 — À définir | ⏳ À faire | — | Backlog d'améliorations |
| Étape 2 — Application de base (fichiers) | ✅ Terminé | 23/03/2026 | Ouverture dossier, arborescence, édition RAW, sauvegarde Ctrl+S + bouton, CRUD fichiers/dossiers |
| Étape 3 — Intégration Git | ✅ Terminé | 23/03/2026 | Détection repo, indicateurs locaux/distants, commit, fetch auto 60s, pull, merge |
| Étape 4 — UI/UX finale | ⏳ À faire | — | En attente des fondations fonctionnelles |
| Étape 5 — À définir | ⏳ À faire | — | Backlog d’améliorations |
...
Gérer les dossier récents (Fichier > Ouvrir... & Spéarateur -> liste des dossiers récemment ouvert)
Gestion bouton droite dans l'arboressence, renommer, nouveau fichier, nouveau dossier, supprimer, last edited (git)
UI Merge plus "sympa"
Choisir son nom au démarage de l'app (configuration git)
Connexion avec github (dans le browser)
Pull un repo (avec search field)
