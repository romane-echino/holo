...
- Name: blockEditor.spec.ts >> BlockEditor — slash commands >> table en milieu de doc préserve les blocs suivants
- Location: tests/e2e/blockEditor.spec.ts:138:3
